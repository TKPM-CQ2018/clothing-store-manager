...
export default function TopProductsPage() {
  ...
  let type='best';
  let chart;
  chart = (<ProfitCP.TopProductsChart filter={filter}/>);
    ...
    <div className="profit">
      <div className="container">
        ...
        <div class='profit-chart'>
          <h2>Top 10 {filter} selling products</h2>
          {chart}
        </div>

        <section className="margin-top">
          <ProfitCP.TopProductsDetail filter={filter}></ProfitCP.TopProductsDetail>
        </section>
